...
void P0_b1PopCallback(void *ptr) // Bouton page précedente (appel page 13)
{
  page13.show();
  num_page = 13;
  ...
  P13_t4.setText(buffer_hour);
  P13_t6.setText(buffer_minute);
}
...
void P0Display() 
{
    ...
    memset(buffer, 0, sizeof(buffer));
    dtostrf(humd, 5, 2, buffer);
    P0_t26.setText(buffer);
    memset(buffer, 0, sizeof(buffer));
